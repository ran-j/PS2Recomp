...
bool ensureSoundDriverMemoryUnlocked(uint8_t *rdram, PS2Runtime *runtime)
{
    if (!rdram || !runtime)
    {
        return false;
...
void handleSoundDriverCommandBuffer(uint8_t *rdram, PS2Runtime *runtime, uint32_t sendBuf, uint32_t sendSize)
{
    ...
    if (!ensureSoundDriverMemoryUnlocked(rdram, runtime))
    {
        return;
    }
...
const char *dtxUrpcCommandName(uint32_t command)
{
    switch (command)
    {
    case 0u: return "SJX_CREATE";
    case 1u: return "SJX_DESTROY";
    case 2u: return "SJX_RESET";
    case 3u: return "SJX_REINIT";
    case 8u: return "PS2RNA_CREATE";
    case 9u: return "PS2RNA_DESTROY";
    case 10u: return "PS2RNA_REINIT";
    case 32u: return "SJRMT_RBF_CREATE";
    case 33u: return "SJRMT_MEM_CREATE";
    case 34u: return "SJRMT_UNI_CREATE";
    case 35u: return "SJRMT_DESTROY";
    case 36u: return "SJRMT_GET_UUID";
    case 37u: return "SJRMT_RESET";
    case 38u: return "SJRMT_GET_CHUNK";
    case 39u: return "SJRMT_UNGET_CHUNK";
    case 40u: return "SJRMT_PUT_CHUNK";
    case 41u: return "SJRMT_GET_NUM_DATA";
    case 42u: return "SJRMT_IS_GET_CHUNK";
    case 43u: return "SJRMT_INIT";
    case 44u: return "SJRMT_FINISH";
